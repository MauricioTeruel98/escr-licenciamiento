...
class EvaluationCompletedNotificationSuperAdmin extends Mailable
{
    use Queueable, SerializesModels;

    protected $user;
    protected $companyName;
    public $subject = 'Evaluación completada';
    ...
    public function build()
    {
        ...
        return $this->view('emails.evaluation_completed_super_admin', [
                'user' => $this->user,
