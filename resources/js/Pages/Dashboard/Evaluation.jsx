                                            ...
                                            <div className='bg-green-100/50 p-4 rounded-lg'>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className='text-green-700'>
                                                        {numeroDePreguntasQueRespondioLaEmpresa} indicadores contestados
                                                    </span>
                                                </div>
                                                <p className="text-sm text-green-700 mt-1">
                                                    Quedan {numeroDePreguntasQueVaAResponderLaEmpresa - numeroDePreguntasQueRespondioLaEmpresa} indicadores por responder
                                                </p>
                                            </div>
                                        </div>
                                    </div>
