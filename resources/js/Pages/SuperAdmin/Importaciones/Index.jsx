...
const ImportacionesPage = ({ auth, title, companiesColumns, usersColumns, usersRequiredColumns, usersOptionalDefaultValues }) => {
                            ...
                            <div className="p-6 bg-white">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="space-y-8">
                                        ...
                                        {/* Campo de importación 3 - Otros datos */}
                                        <div className="space-y-2 border border-gray-200 rounded-lg p-4 opacity-50">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <input
                                                    ...
                                                    accept=".csv"
                                                    disabled
                                                    className="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 w-full cursor-not-allowed"
                                                />
                                            </div>
