                        ...
                        {isLoginPage ? (
                            <>
                                ...
                                <p className="text-white mb-6">
                                    Le invitamos a completar el proceso de <span className='font-bold'>autoevaluación</span> en el cual podrá conocer la etapa en la que se encuentra su empresa para iniciar el proceso de licenciamiento de uso corporativo de <i>esencial</i> COSTA RICA.
                                </p>
                                <p className="text-white mb-6">
