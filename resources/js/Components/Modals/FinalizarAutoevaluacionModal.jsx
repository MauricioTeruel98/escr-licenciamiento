...
export default function FinalizarAutoevaluacionModal({ isOpen, onClose, onConfirm, status = 'initial', isProcessing = false }) {
                ...
                return (
                    <>
                        ...
                        <p className="text-sm text-gray-500">
                            Estamos finalizando su autoevaluación, por favor espere un momento...
                        </p>
                    </>
                );
            case 'completed':
                return (
                    <>
                        ...
                        <p className="text-sm text-gray-500">
                            Su solicitud de evaluación ha sido enviada satisfactoriamente, pronto nos comunicaremos para continuar el proceso.
                        </p>
                    </>
                );
            default: // 'initial'
                return (
                    <>
                        ...
                        <p className="text-sm text-gray-500">
                            ¿Está seguro que desea finalizar y enviar su autoevaluación?
                        </p>
                    </>
                );
        }
