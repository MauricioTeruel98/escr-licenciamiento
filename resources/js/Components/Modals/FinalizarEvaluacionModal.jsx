...
export default function FinalizarEvaluacionModal({ isOpen, onClose, onConfirm, status = 'initial', isProcessing = false }) {
                ...
                return (
                    <>
                        ...
                        <p className="text-sm text-gray-500">
                            Estamos finalizando su evaluación, por favor espere un momento...
                        </p>
                    </>
                );
            case 'completed':
                return (
                    <>
                        ...
                        <p className="text-sm text-gray-500">
                            Su evaluación ha sido finalizada con éxito, pronto nos comunicaremos para continuar el proceso.
                        </p>
                    </>
                );
            default: // 'initial'
                return (
                    <>
                        ...
                        <p className="text-sm text-gray-500">
                            ¿Está seguro que desea finalizar y enviar su evaluación?
                        </p>
                    </>
                );
        }
