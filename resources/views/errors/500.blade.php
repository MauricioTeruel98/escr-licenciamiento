...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-100">
        <div class="w-full sm:max-w-md p-6 bg-white shadow-md overflow-hidden sm:rounded-lg text-center">
            <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mb-2">Error 500</h1>
            <p class="text-gray-600 mb-6">Ha ocurrido un error en el servidor. Por favor, inténtalo de nuevo más tarde.</p>
